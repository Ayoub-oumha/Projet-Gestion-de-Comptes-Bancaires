        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 transform -translate-x-full lg:translate-x-0 lg:relative lg:flex w-64 bg-gray-900 transition-transform duration-200 ease-in-out z-30">
            <div class="flex flex-col h-full">
                ...
                <nav class="mt-6 flex-grow">
                    <a href="dashbord_admin.php" class="flex items-center w-full px-6 py-3  text-gray-400 ">
                        <i data-lucide="layout-dashboard" class="w-5 h-5 mr-3"></i>
                        <span>Dashboard</span>
                    </a>
                    <a href="clients.html" class="flex items-center w-full px-6 py-3 text-white hover:text-white hover:bg-gray-800 bg-gray-800">
                ...
                <div class="border-t border-gray-800 p-6">
                    <div class="relative">
                        <button
                            ...
                            <img src="https://imageio.forbes.com/specials-images/imageserve/663e595b4509f97fdafb95f5/0x0.jpg?format=jpg&crop=383,383,x1045,y23,safe&height=416&width=416&fit=bounds" alt="Admin" class="w-8 h-8 rounded-full">
